...
class ScreenshotDetector(private val context: Context,private val screenshotListener: ScreenshotListener) {
        ...
        context.contentResolver.query(
            ...
            while (cursor.moveToNext()) {
                ...
                if (path.contains("screenshot", true)) {
                    ...
                    screenshotListener.screenShotTaken(createTmpFileFromUri(context,uri,""+System.currentTimeMillis()))
                }
            }
        }
    }
